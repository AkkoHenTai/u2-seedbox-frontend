interface ButtonProps {
    ...
    disabled?: boolean;
    loading?: boolean;
    nativeType?: 'button' | 'submit' | 'reset'; // 原生类型
    onClick?: () => void;
}
...
const Button: React.FC<ButtonProps> = ({ type, children, disabled, loading, nativeType = 'button', onClick }) => {
    return (
        <button
            type={nativeType}
            className={`${styles[type]} ${disabled ? disabledStyles : ''}`}
